...
public class CharacterRaycastController : MonoBehaviour
{
	...
	private void OnDrawGizmos() {
		//Gizmos.DrawSphere(boxCollider2D.bounds.max, 0.1f);
		...
		//Gizmos.DrawSphere(boxCollider2D.bounds.max - new Vector3(0f, boxCollider2D.bounds.extents.y * 2, 0f), 0.1f);
		...
		//Gizmos.DrawSphere(boxCollider2D.bounds.min, 0.1f);
		...
		//Gizmos.DrawSphere(boxCollider2D.bounds.min + new Vector3(0f, boxCollider2D.bounds.extents.y * 2, 0f), 0.1f);
